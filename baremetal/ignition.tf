data "ignition_config" "controller" {
  ...
  networkd = [
    "${element(module.controller_ignition_networkd.net_10_external0_link, count.index)}",
...
data "ignition_config" "worker" {
  ...
  networkd = [
    "${element(module.worker_ignition_networkd.net_10_external0_link, count.index)}",
    "${module.worker_ignition_networkd.net_20_external0_network}",
    "${element(module.worker_ignition_networkd.net_10_internal0_link, count.index)}",
  ...
  systemd = [
    ...
    "${element(module.worker_ignition_systemd.kubelet_worker_service, count.index)}",
...
data "ignition_config" "elasticsearch_worker" {
  ...
  networkd = [
    "${element(module.elasticsearch_worker_ignition_networkd.net_10_external0_link, count.index)}",
    "${module.elasticsearch_worker_ignition_networkd.net_20_external0_network}",
    "${element(module.elasticsearch_worker_ignition_networkd.net_10_internal0_link, count.index)}",
  ...
  systemd = [
    ...
    "${element(module.elasticsearch_worker_ignition_systemd.kubelet_elasticsearch_worker_service, count.index)}",
  ]

  files = [
    "${module.elasticsearch_worker_ignition_files.kubelet_env}",
    "${element(module.elasticsearch_worker_ignition_files.hostname, count.index)}",
...
data "ignition_config" "postgres_worker" {
  ...
  networkd = [
    "${element(module.postgres_worker_ignition_networkd.net_10_external0_link, count.index)}",
    "${module.postgres_worker_ignition_networkd.net_20_external0_network}",
    "${element(module.postgres_worker_ignition_networkd.net_10_internal0_link, count.index)}",
  ...
  systemd = [
    ...
    "${element(module.postgres_worker_ignition_systemd.kubelet_postgres_worker_service, count.index)}",
  ]
...
data "ignition_config" "prometheus_worker" {
  ...
  networkd = [
    "${element(module.prometheus_worker_ignition_networkd.net_10_external0_link, count.index)}",
    "${module.prometheus_worker_ignition_networkd.net_20_external0_network}",
    "${element(module.prometheus_worker_ignition_networkd.net_10_internal0_link, count.index)}",
  ...
  systemd = [
    ...
    "${element(module.prometheus_worker_ignition_systemd.kubelet_prometheus_worker_service, count.index)}",
  ]

  files = [
    "${module.prometheus_worker_ignition_files.kubelet_env}",
    "${element(module.prometheus_worker_ignition_files.hostname, count.index)}",
